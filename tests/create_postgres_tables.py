...
async def create_entity_table(pool: Pool, app_id_field: str = "id", db_id_field: str = "_id"):
    """
    ...
    """
    print(f"Creating test table for 'entities' with app_id_field={app_id_field}, db_id_field={db_id_field}")
