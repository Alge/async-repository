...
def test_pop_from_nested_list():
    ...
    assert isinstance(result[0], PopOperation) and result[0].field_path == "departments.0.members" and result[0].position == 1
    assert isinstance(result[1], PopOperation) and result[1].field_path == "departments.0.members" and result[1].position == -1
    assert isinstance(result[2], PopOperation) and result[2].field_path == "departments.0.categories.0.items" and result[2].position == 1
    assert isinstance(result[3], PopOperation) and result[3].field_path == "departments.0.categories.0.tags" and result[3].position == 1
    assert isinstance(result[4], PopOperation) and result[4].field_path == "departments.0.categories.0.counts" and result[4].position == -1
